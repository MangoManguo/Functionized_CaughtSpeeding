...
function btnClicked() {
  ...
  document.getElementById("d1-ticket").innerHTML = caughtSpeeding(
    d1Speed,
    d1Limit
  );
  document.getElementById("d2-ticket").innerHTML = caughtSpeeding(
    d2Speed,
    d2Limit
  );
  document.getElementById("d3-ticket").innerHTML = caughtSpeeding(
    d3Speed,
    d3Limit
  );

  function caughtSpeeding(speed, limit) {
    let ticket;
    if (speed > limit + 40) {
